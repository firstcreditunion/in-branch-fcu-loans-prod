...
export default function Logo({ disabledLink = true }) {
  const logo = (
    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', alignContent: 'center', flexGrow: 1, minHeight: '80vh' }}>
      <Stack direction='column' justifyContent='center' alignItems='center' sx={{ width: 300, height: 140 }}>
        <motion.svg xmlns='http://www.w3.org/2000/svg' width='100%' viewBox='-3 -3 300 140' initial='hidden' animate='visible'>
