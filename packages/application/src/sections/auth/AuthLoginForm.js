...
import FormProvider from '../../components/rhf-components/FormProvider'
import RFHTextField from '../../components/rhf-components/RFHTextField'
...
export default function AuthLoginForm() {
  ...
  const onSubmit = async (data) => {
    try {
      await register(data.email, data.password, [], null, (err, data) => {
