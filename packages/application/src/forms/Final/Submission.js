...
export default function Submission() {
  ...
  const primeResidentialDetails = [
    {
      ...
      streetOrPostalName: nfd_NormaliseString(currResAddressSelectedStreetOrPostalName),
      streetDirection: currResAddressSelectedStreetDirection,
      streetType: null,
      suburb: nfd_NormaliseString(currResAddressSelectedSuburb),
      city: nfd_NormaliseString(currResAddressSelectedCity),
      state: '',
    ...
    },
    {
      ...
      streetOrPostalName: nfd_NormaliseString(prevResAddressSelectedStreetOrPostalName),
      streetDirection: nfd_NormaliseString(prevResAddressSelectedStreetDirection),
      streetType: null,
      suburb: nfd_NormaliseString(prevResAddressSelectedSuburb),
      city: nfd_NormaliseString(prevResAddressSelectedCity),
      state: '',
  ...
  const jointResidentialDetails = [
    {
      ...
      streetOrPostalName: nfd_NormaliseString(jointcurrResAddressSelectedStreetOrPostalName),
      streetDirection: jointcurrResAddressSelectedStreetDirection,
      streetType: null,
      suburb: nfd_NormaliseString(jointcurrResAddressSelectedSuburb),
      city: nfd_NormaliseString(jointcurrResAddressSelectedCity),
      state: '',
    ...
    },
    {
      ...
      streetOrPostalName: nfd_NormaliseString(jointprevResAddressSelectedStreetOrPostalName),
      streetDirection: jointprevResAddressSelectedStreetDirection,
      streetType: null,
      suburb: nfd_NormaliseString(jointprevResAddressSelectedSuburb),
      city: nfd_NormaliseString(jointprevResAddressSelectedCity),
      state: '',
  ...
  const primeEmployment = [
    {
      ...
      employerName: isNotAnEmployment(employmentType) ? employmentTypes(employmentType)?.value : nfd_NormaliseString(employerName),
    ...
    },
    {
      ...
      employerName: isNotAnEmployment(prevEmpemploymentType) ? employmentTypes(prevEmpemploymentType)?.value : nfd_NormaliseString(prevEmpemployerName),
  ...
  const jointEmployment = [
    {
      ...
      employerName: isNotAnEmployment(jointemploymentType) ? employmentTypes(jointemploymentType)?.value : nfd_NormaliseString(jointemployerName),
    ...
    },
    {
      ...
      employerName: isNotAnEmployment(jointprevEmpemploymentType) ? employmentTypes(jointprevEmpemploymentType)?.value : nfd_NormaliseString(jointprevEmpemployerName),
  ...
  const lpiGrossPremium = awsCalculatedLpiAmount === awsCalculatedLpiGrossPremiumAmount ? awsCalculatedLpiAmount : awsCalculatedLpiGrossPremiumAmount
  ...
  let insurance = [
    {
      ...
      joint: 'N',
      discount: 'N',
      policyDescription: hasLpiPrimeDeath ? title + ' ' + lastName : '',
    ...
    },
    {
      ...
      joint: 'Y',
      discount: 'N',
      policyDescription: hasLpiJointDeath ? jointtitle + ' ' + jointlastName : '',
    ...
    },
    {
      ...
      policyDescription: hasLpiPrimeDisability ? title + ' ' + lastName : '',
    ...
    },
    {
      ...
      joint: 'Y',
      discount: hasLpiPrimeDisability && hasLpiJointDisability ? 'Y' : 'N',
      policyDescription: hasLpiJointDisability ? jointtitle + ' ' + jointlastName : '',
    ...
    },
    {
      ...
      policyDescription: hasLpiPrimeBankruptcy ? title + ' ' + lastName : '',
    ...
    },
    {
      ...
      joint: 'Y',
      discount: hasLpiPrimeBankruptcy && hasLpiJointBankruptcy ? 'Y' : 'N',
      policyDescription: hasLpiJointBankruptcy ? jointtitle + ' ' + jointlastName : '',
    ...
    },
    {
      ...
      policyDescription: hasLpiPrimeCriticalIllness ? title + ' ' + lastName : '',
    ...
    },
    {
      ...
      joint: 'Y',
      discount: hasLpiPrimeCriticalIllness && hasLpiJointCriticalIllness ? 'Y' : 'N',
      policyDescription: hasLpiJointCriticalIllness ? jointtitle + ' ' + jointlastName : '',
    ...
    if (jointApplication) {
      return JSON.stringify({
        ...
        insurance: insurance
          ...
          .map((item) => {
            return { component: item?.component, joint: item?.joint, discount: item?.discount, policyDescription: item?.policyDescription }
          }),
        associatedClients: {
          data: [
            {
            ...
            attributes: {
              ...
              clientMaint: {
                ...
                generalDetails: {
                  ...
                  individualDetails: {
                    title: title,
                    forename: nfd_NormaliseString(concatForenames),
                    surname: nfd_NormaliseString(lastName),
            ...
            attributes: {
              ...
              clientMaint: {
                ...
                generalDetails: {
                  ...
                  individualDetails: {
                    title: jointtitle,
                    forename: nfd_NormaliseString(concatJointForenames),
                    surname: nfd_NormaliseString(jointlastName),
    ...
    if (jointApplication) {
      return {
        ...
        loanProtectionInsurance: {
          totalPremium: lpiGrossPremium == null ? 0 : lpiGrossPremium,
          prime: {
          ...
          <ContentStyle sx={{ width: '100%', maxWidth: '100%' }}>
            ...
            <Stack direction='column' justifyContent='flex-start' spacing={3}>
              ...
              <Stack direction='row' justifyContent='space-between' alignItems='center'>
                ...
                <ValueTypography>{fCurrency(lpiGrossPremium == null ? 0 : lpiGrossPremium)}</ValueTypography>
              </Stack>
              <Stack direction='row' justifyContent='space-between' alignItems='center'>
