...
function uploadFileUndraw({ ...rest }) {
  ...
  return (
    <Stack spacing={2} alignItems='center' justifyContent='center' direction='column' sx={{ width: 1, textAlign: { xs: 'center', md: 'left' } }}>
      <Box {...rest} sx={{ display: 'flex', justifyContent: 'center' }}>
        <svg xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' width='50%' height='50%' viewBox='0 0 865.67004 776.44344'>
          ...
          <circle cx='694.19401' cy='614.02963' r='87.85039' fill='#00687f' />
          ...
          <path d='M635.85911,390.6071H506.51316a3.847,3.847,0,0,1-3.84277-3.84277V285.81706a3.847,3.847,0,0,1,3.84277-3.84277H635.85911a3.847,3.847,0,0,1,3.84277,3.84277V386.76433A3.847,3.847,0,0,1,635.85911,390.6071Z' transform='translate(-208.9778 -99.05999)' fill='#bbbb14' />
        </svg>
      </Box>
      {!downSm && (
        <Stack direction='column' justifyContent='center' alignItems='center' spacing={1}>
          <Typography variant='body2'>Drag & drop your bank statemnts here </Typography>
          <Typography color='primary' variant='body2' sx={{ fontWeight: 'bold' }}>
            or
          </Typography>
          <Stack direction='row'>
            <Typography variant='body2'>
              Click <strong>here</strong> to upload from your device.
            </Typography>
          </Stack>
        </Stack>
      )}
        ...
        <Stack direction='column' justifyContent='center' alignItems='center' spacing={1}>
          <Stack direction='row'>
            <Typography variant='caption'>
              Click <strong>here</strong> to upload your bank statement.
            </Typography>
          </Stack>
        </Stack>
      )}
...
export default memo(uploadFileUndraw)
